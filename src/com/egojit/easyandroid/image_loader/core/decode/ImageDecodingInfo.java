 ...
 *******************************************************************************/
package com.egojit.easyandroid.image_loader.core.decode;

import android.annotation.TargetApi;
import android.graphics.BitmapFactory.Options;
import android.os.Build;

import com.egojit.easyandroid.image_loader.core.DisplayImageOptions;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.egojit.easyandroid.image_loader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
