 ...
 *******************************************************************************/
package com.egojit.easyandroid.image_loader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;
import com.egojit.easyandroid.image_loader.cache.disc.DiskCache;
import com.egojit.easyandroid.image_loader.cache.disc.naming.FileNameGenerator;
import com.egojit.easyandroid.image_loader.cache.memory.MemoryCache;
import com.egojit.easyandroid.image_loader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.egojit.easyandroid.image_loader.core.assist.FlushedInputStream;
import com.egojit.easyandroid.image_loader.core.assist.ImageSize;
import com.egojit.easyandroid.image_loader.core.assist.QueueProcessingType;
import com.egojit.easyandroid.image_loader.core.decode.ImageDecoder;
import com.egojit.easyandroid.image_loader.core.download.ImageDownloader;
import com.egojit.easyandroid.image_loader.core.process.BitmapProcessor;
import com.egojit.easyandroid.image_loader.utils.L;
import com.egojit.easyandroid.image_loader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.egojit.easyandroid.image_loader.cache.disc.impl.UnlimitedDiscCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.egojit.easyandroid.image_loader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.egojit.easyandroid.image_loader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.egojit.easyandroid.image_loader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.egojit.easyandroid.image_loader.cache.disc.impl.ext.LruDiscCache LruDiscCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.egojit.easyandroid.image_loader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.egojit.easyandroid.image_loader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.egojit.easyandroid.image_loader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.egojit.easyandroid.image_loader.cache.disc.impl.UnlimitedDiscCache
		 * BaseDiscCache}. Cache directory is defined by
		 * {@link com.egojit.easyandroid.image_loader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.egojit.easyandroid.image_loader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.egojit.easyandroid.image_loader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.egojit.easyandroid.image_loader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.egojit.easyandroid.image_loader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
