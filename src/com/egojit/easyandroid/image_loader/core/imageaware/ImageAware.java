 ...
 *******************************************************************************/
package com.egojit.easyandroid.image_loader.core.imageaware;
 ...
 * through {@link com.egojit.easyandroid.image_loader.core.ImageLoader ImageLoader}.
 * It can wrap any Android {@link android.view.View View} which can be accessed by {@link #getWrappedView()}. Wrapped
 * view is returned in {@link com.egojit.easyandroid.image_loader.core.listener.ImageLoadingListener ImageLoadingListener}'s
 * callbacks.
 *
...
public interface ImageAware {
	...
	/**
	 * Returns {@linkplain com.egojit.easyandroid.image_loader.core.assist.ViewScaleType scale type} which is used for
	 ...
	 * {@link com.egojit.easyandroid.image_loader.core.listener.ImageLoadingListener#onLoadingCancelled(String,
	 ...
	 * {@linkplain com.egojit.easyandroid.image_loader.core.DisplayImageOptions.Builder#showImageForEmptyUri(
	 *android.graphics.drawable.Drawable) for empty Uri},
	 * {@linkplain com.egojit.easyandroid.image_loader.core.DisplayImageOptions.Builder#showImageOnLoading(
	 *android.graphics.drawable.Drawable) on loading} or
	 * {@linkplain com.egojit.easyandroid.image_loader.core.DisplayImageOptions.Builder#showImageOnFail(
	 *android.graphics.drawable.Drawable) on loading fail}. These drawables can be specified in
	 * {@linkplain com.egojit.easyandroid.image_loader.core.DisplayImageOptions display options}.<br />
	 * Also can be called in {@link com.egojit.easyandroid.image_loader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
	 ...
	 * {@link com.egojit.easyandroid.image_loader.core.display.BitmapDisplayer BitmapDisplayer}.< br />
	 * Is called on UI thread if ImageLoader was called on UI thread. Otherwise - on background thread.
	 *
